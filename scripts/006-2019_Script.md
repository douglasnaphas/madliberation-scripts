...
...and speaking of kids...they say the darndest things, am I right? Especially when they are forced to say things in Hebrew. Last year, at Passover, some kid asked, {{ a dumb question // Is the moon made of cheese? //  __ ? // What happens if I fall into my bellybutton? }}? Isn’t that the darndest? Good thing we don’t have any kids here tonight. 
...
Pretty sure this wasn’t going anywhere, Moses summoned elephant-sized {{ animals  // pandas // some__ // porcupines }} , {{ animals  // gorillas // some__ // porcupines }} , and {{ animals  // pandas // some__ // octopuses }} to roam the streets.
...
Lastly, but not the last thing before we eat, this is {{a spice// oregano// // curry}}, a bitter herb. It symbolizes the bitterness of slavery and of having to wait 25 hours to eat dinner.
